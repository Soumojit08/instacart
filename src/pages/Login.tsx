      ...
      <div className="hidden lg:flex lg:w-1/2 bg-app-green relative items-center justify-center">
        ...
        <div className="relative text-center px-12">
          ...
          <p className="text-white/60 font-serif text-xl max-w-sm mx-auto">
            Fresh groceries and many more items delivered to your doorstep.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <label className="text-sm flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3 text-sm bg-white rounded-xl border focus:border-app-green focus:outline-none transition-all"
                  />
                </div>
              </label>
            )}
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex flex-center w-full py-3 bg-green-950 text-white font-semibold rounded-xl hover:bg-green-900 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
